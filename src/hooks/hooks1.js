...
const HooksContainer1 = () => {
  ...
  //incrementing the local state with useState Hook
  ...
  //update the useEffectValue property of local state
  const handleuseEffectValue = () => {
    setUseEffectValue("some string")
  }

  /*how we dispatch our actions to change our stateprop1 
  in Reducer1 from true to false, and vice versa*/
